  ...
  Widget build(BuildContext context) {
    return ListTile(
      leading: CircleAvatar(
        ...
        child: Icon(Icons.memory, color: _statusColor(device.status)),
      ),
      ...
      trailing: Chip(
        label: Text(device.status.label, style: const TextStyle(fontSize: 12)),
        backgroundColor: _statusColor(device.status).withValues(alpha: 0.15),
        ...
        child: ConstrainedBox(
          ...
          child: const Center(
            child: Padding(
              ...
              child: Text('No devices yet — tap "New Device" to get started'),
            ),
          ),
        ),
      ),
