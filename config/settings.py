"""
Django settings for care_path project.
...
SECRET_KEY = 'django-insecure-@s-61!3gzlgna67+dw$dt@$ts&1a^tbx%-cz_hode*(ncrlw4!'
...
INSTALLED_APPS = [
    ...
    "corsheaders",  # للسماح لتطبيق Flutter بالاتصال أثناء التطوير
    "accounts",
    "devices",
    'cases',
    'treatments',
